...
const groceries = ["eggs", "milk", "rice", "coffee"];
console.log("lenght:", groceries.length);
...
const removedEnd = groceries.pop();
console.log("removed End", removedEnd);
...
const removedStart = groceries.shift();

console.log("remove start shift", removedStart);
...
const removedItem = groceries.splice(2, 1);
